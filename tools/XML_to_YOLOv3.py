...
Dataset_names_path = "model_data/mydataset_names.txt"
Dataset_train = "model_data/mydataset_train.txt"
Dataset_test = "model_data/mydataset_test.txt"
is_subfolder = True
...
def ParseXML(img_folder, file):
    print('parse xml')
    print(glob.glob(img_folder+'/*.xml'))
